...
2) header зацепил, хотя этого явно нет на макете. Или дучше сделать как обычную секцию?
3) адаптив для картинок в секции Create и Subscribe. Правильно ли сделанно?
4) кнопки на макете с акцентным цветом выше чем темные. Это лучше реализовать через проопсы?
*/